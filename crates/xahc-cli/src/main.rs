...
enum Cmd {
    ...
    Prove {
        ...
        input: PathBuf,
        /// Invariant: limit | guardrail | termination | monotonic | nospend | conservation | limit-iou | authz | validate | overflow | foreign-authz | reserve | time-nonce | emission | period-budget | reentrancy | unchecked-return | validate-range
