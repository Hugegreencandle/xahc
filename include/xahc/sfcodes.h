/**
 * xahc/sfcodes.h — serialized field codes.
 * Generated from XRPLF/hook-macros sfcodes.h (Xahau). Keep in sync upstream.
 * Encoding: (type_code << 16) + field_code.
 */
#ifndef XAHC_SFCODES_H
#define XAHC_SFCODES_H 1
