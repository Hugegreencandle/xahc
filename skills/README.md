...
| **xahau-mcp-simulate** | Predict what a Xahau tx will DO before signing — keyless, no deploy (xahau-mcp's simulate_transaction / execute_hook / what_if). Simulate = one tx; prove = all inputs. |
